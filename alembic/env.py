...
from app.models.users import Base  # Import your application's Base or MetaData object
...
# Set the target_metadata to your model's MetaData object (Base.metadata)
